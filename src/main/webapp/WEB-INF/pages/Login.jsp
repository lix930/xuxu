...
<div class="container">
    ...
    <div class="row" id="login-overview">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <form id="login-form" role="form" action="/services/users/check-user" method="post">
              ...
              <input type="checkbox" name="remember_me" id="remember_me" checked="checked" class="hidden">
                ...
                <div class="form-group">
                    <a href="/forgot-password" class="forgot-password pull-right">忘记密码</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="row" id="register-overview">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <form id="register-form" role="form" action="/services/users/check-user" method="post">
                <div class="form-group">
